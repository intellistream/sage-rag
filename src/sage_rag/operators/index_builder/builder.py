...
class IndexBuilder:
    ...
    Architecture Pattern:
        - sage-rag defines this builder (orchestration logic)
        - sage-middleware provides SageDB backend
        - sage-rag/backends provides ChromaDB backend
        - sage-cli uses IndexBuilder with injected backend factory
