# transformers and torch are optional — install with: pip install transformers torch
try:
    import torch
...
class BGEReranker(MapOperator):
    ...
    def execute(self, data: RAGInput) -> RAGResponse:
        ...
        try:
            ...
            raise RuntimeError(f"BGEReranker error: {str(e)}")  # noqa: B904
...
class LLMbased_Reranker(MapOperator):
    ...
    def execute(self, data: RAGInput) -> RAGResponse:
        ...
        try:
            ...
            raise RuntimeError(f"Reranker error: {str(e)}")  # noqa: B904
