...
Layer: sage-rag backends (L2/L3 boundary)
"""
...
from sage_rag.backends.chroma import ChromaBackend
...
class ChromaVectorStoreAdapter:
    ...
    a circular dependency). Instead, we provide duck-typing compatibility.
